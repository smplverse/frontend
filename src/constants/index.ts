...
export const CONTRACT_ADDRESS_RINKEBY =
  '0x78D063b2dA98901F9483C3c22F5a8ea630F95aBb'
...
export const PROJECT_ID = '33222885df5c4514a81ed29a4c106718'

export { default as WHITELISTED_ADDRESSES } from './whitelisted-addresses'
