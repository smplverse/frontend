...
export const MintPageText = () => (
  <Container>
    ...
    <Text>
      The collection comprises 7,667 synthetic face images generated to improve face tracking 
      in Microsoft's mixed reality headsets. 
    </Text>
    <Text>
    ...
    <Text>
      ...
      avatars whose naturalism they are meant to enhance.
    </Text>
    <Text>
